<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formularioRegistro.aspx.cs" Inherits="OracleEstacionamiento.formularioRegistro" %>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="formularioRegistro.aspx">Registro <span class="sr-only">(actual)</span></a>
      </li>
